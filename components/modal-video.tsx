...
export default function ModalVideo({
  ...
  return (
    <div id="demo" className="flex justify-center border rounded-2xl border-gray-800 w-4/6">
      <button
      ...
      >
        ...
        >
          ...
          />
          <path
            className="fill-white-500 drop-shadow-2xl"
        ...
        <Dialog initialFocus={videoRef} onClose={() => setModalOpen(false)}>
          ...
          >
            <div className="mx-auto flex h-full max-w-5xl items-center">
              <DialogPanel className="aspect-video max-h-full w-full overflow-hidden rounded-3xl bg-black shadow-2xl border">
                <video
                  ref={videoRef}
                  width={videoWidth}
                  height={videoHeight}
